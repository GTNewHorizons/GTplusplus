                ...
                for (int col = 0; col < 9; col++) {
                    ...
                    if (component != null && !component.isBroken()) {
                        if (component.getCurrentHeat() > 0.0) {
                            ...
                            component
                                    .info
                                    .append("ComponentInfo.RemainingHeat ")
                                    .append(component.getCurrentHeat());
                        }
                    }
                }
            }
                        ...
                        for (int col = 0; col < 9; col++) {
                            ...
                            if (component != null && !component.isBroken()) {
                                ...
                                if (component.getCurrentHeat() == 0.0 && needsCooldown[row][col]) {
                                    component
                                            .info
                                            .append("ComponentInfo.CooldownTime ")
            ...
            for (int col = 0; col < 9; col++) {
                ...
                if (component != null) {
                    if (component.getVentCoolingCapacity() > 0) {
                        component
                                .info
                                .append("ComponentInfo.UsedCooling ")
                                .append(component.getBestVentCooling())
                                .append(" | ")
                                .append(component.getVentCoolingCapacity());
                        ...
                        component
                                .info
                                .append("ComponentInfo.ReceivedHeat ")
                                .append(component.getBestCondensatorCooling());
                        ...
                        if (!reactor.isFluid() && component.getMaxEUGenerated() > 0) {
                            component
                                    .info
                                    .append("ComponentInfo.GeneratedEU ")
                                    .append(component.getMinEUGenerated())
                                    .append(" | ")
                                    .append(component.getMaxEUGenerated());
                        }
                        component
                                .info
                                .append("ComponentInfo.GeneratedHeat ")
                                .append(component.getMinHeatGenerated())
                                .append(" | ")
                                .append(component.getMaxHeatGenerated());
                    }
                    if (component.getMaxReachedHeat() > 0) {
                        component
                                .info
                                .append("ComponentInfo.ReachedHeat ")
                                .append(component.getMaxReachedHeat())
                                .append(" | ")
                                .append(component.getMaxHeat());
                    }
                }
            }
        }
                ...
                if (component != null && reactor.isAutomated()) {
                    if (component.getMaxHeat() > 1) {
                        if (component.getAutomationThreshold() > component.getInitialHeat()
                            ...
                            component
                                    .info
                                    .append("ComponentInfo.ReplacedTime | ")
                                    .append(reactorTicks);
