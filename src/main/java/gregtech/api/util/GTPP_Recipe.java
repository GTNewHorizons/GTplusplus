...
public class GTPP_Recipe extends GT_Recipe implements IComparableRecipe {
	...
	public static class GTPP_Recipe_Map {
		...
		public static final GTPP_Recipe_Map_Internal sQuantumForceSmelterRecipes = new GTPP_Recipe_Map_MultiNoCell(new HashSet<GT_Recipe>(200), "gtpp.recipe.quantumforcesmelter", "Quantum Force Smelter", null, RES_PATH_GUI + "basicmachines/FissionFuel", 9, 9, 1, 0, 1, E, 1, E, true, true);
