...
public class Container_FeedingTrough extends Container {

	protected TileEntityFeedingTrough tile_entity;
	...
	public Container_FeedingTrough(final InventoryPlayer inventory, final TileEntityFeedingTrough te) {
		this.tile_entity = te;
		...
		for (var6 = 0; var6 < 3; var6++) {
			for (var7 = 0; var7 < 5; var7++) {
				...
				this.addSlotToContainer(new Slot(te, o++, 44 + (var7 * 18), 15 + (var6 * 18)));
			}
		}
	...
	public void onContainerClosed(final EntityPlayer par1EntityPlayer) {
		...
		this.tile_entity.closeInventory();
	}

	@Override
	public boolean canInteractWith(final EntityPlayer par1EntityPlayer) {
		if (this.worldObj.getBlock(this.posX, this.posY, this.posZ) != ModBlocks.blockAnimalFeeder) {
			return false;
		}
