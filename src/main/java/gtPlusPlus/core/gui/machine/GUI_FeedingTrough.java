...
import gtPlusPlus.core.container.Container_FeedingTrough;
...
public class GUI_FeedingTrough extends GuiContainer {

	private static final ResourceLocation craftingTableGuiTextures = new ResourceLocation(CORE.MODID, "textures/gui/FishTrap.png");

	public GUI_FeedingTrough(final InventoryPlayer player_inventory, final TileEntityFeedingTrough te){
		super(new Container_FeedingTrough(player_inventory, te));
	}
