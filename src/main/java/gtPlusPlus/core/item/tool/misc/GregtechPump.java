...
public class GregtechPump extends Item implements ISpecialElectricItem, IElectricItemManager, IFluidContainerItem {
    ...
    private final HashMap<Integer, EnumChatFormatting> descColour = new LinkedHashMap<>();
    private final HashMap<Integer, String> itemName = new LinkedHashMap<>();
    private final HashMap<Integer, String> itemDescription = new LinkedHashMap<>();
    ...
    public final GregtechPump addItemBehavior(final int aMetaValue, final IItemBehaviour<GregtechPump> aBehavior) {
        ...
        ArrayList<IItemBehaviour<GregtechPump>> tList = this.mItemBehaviors.computeIfAbsent((short) aMetaValue, k -> new ArrayList<>(1));
        tList.add(aBehavior);
        return this;
    }
