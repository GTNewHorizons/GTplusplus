...
import gtPlusPlus.api.objects.minecraft.multi.*;
...
import gtPlusPlus.core.util.reflect.*;
...
import gtPlusPlus.xmod.gregtech.common.*;
import gtPlusPlus.xmod.gregtech.common.blocks.fluid.GregtechFluidHandler;
import gtPlusPlus.xmod.gregtech.common.computer.*;
...
import gtPlusPlus.xmod.gregtech.loaders.recipe.*;
			...
			if (aDataOrb != null) {
				...
				if (aOutput != null) {
					...
					if (aFluid != null && aFluid.amount > 0) {
						...
						if (tMaterial != null && tMaterial != Materials._NULL && tMaterial.mElement != null && tMaterial.mElement != Element._NULL) {
