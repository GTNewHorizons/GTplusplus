...
public class GregtechMetaTileEntity_IsaMill extends GregtechMeta_MultiBlockBase<GregtechMetaTileEntity_IsaMill> {
	...
	public IStructureDefinition<GregtechMetaTileEntity_IsaMill> getStructureDefinition() {
		if (this.STRUCTURE_DEFINITION == null) {
			this.STRUCTURE_DEFINITION = StructureDefinition.<GregtechMetaTileEntity_IsaMill>builder()
	...
	public boolean checkMachine(IGregTechTileEntity aBaseMetaTileEntity, ItemStack aStack) {
		...
		return checkPiece(this.mName, 1, 1, 0) && this.mCasing >= 48 - 8 && checkHatch();
	}
	...
	public boolean addToMachineList(IGregTechTileEntity aTileEntity, int aBaseCasingIndex) {
		...
		if (aMetaTileEntity instanceof GT_MetaTileEntity_Hatch_MillingBalls) {
			...
			return addToMachineListInternal(this.mMillingBallBuses, aMetaTileEntity, aBaseCasingIndex);
		}
	...
	public void checkForEntities(IGregTechTileEntity aBaseMetaTileEntity, long aTime) {
		...
		AutoMap<EntityLivingBase> aEntities = getEntities(this.mFrontBlockPosCache, aBaseMetaTileEntity.getWorld());
	...
	private ItemStack findMillingBall(ItemStack[] aItemInputs) {
		if (this.mMillingBallBuses.isEmpty() || this.mMillingBallBuses.size() > 1) {
			return null;
		}
		else {
