...
public class GregtechRecipeAdder implements IGregtech_RecipeAdder {
    ...
    @Override
    public boolean addQuantumTransformerRecipe(final ItemStack[] aInput, FluidStack aOutput, final int aChance, int aDuration,
                                           final int aEUt) {
        return addQuantumTransformerRecipe(aInput, null, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, 3700);
    }

    @Override
    public boolean addQuantumTransformerRecipe(final ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput,
                                           final int aChance, int aDuration, final int aEUt) {
        return addQuantumTransformerRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, 3700);
    }

    @Override
    public boolean addQuantumTransformerRecipe(final ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, ItemStack[] aOutputStack,
                                           final int aChance[], int aDuration, final int aEUt) {
        return addQuantumTransformerRecipe(aInput, aInputFluid, aOutput, aOutputStack, aChance, aDuration, aEUt, 3700);
    }

    @Override
    public boolean addQuantumTransformerRecipe(ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, int aChance,
                                           int aDuration, int aEUt, int aSpecialValue) {
        return addQuantumTransformerRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, aSpecialValue);
    }

    @Override
    public boolean addQuantumTransformerRecipe(ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, ItemStack[] aOutputStack, int[] aChance,
                                           int aDuration, int aEUt, int aSpecialValue) {
        if ((aInput == null) || (aOutput == null)) {
            Logger.WARNING("Fail - Input or Output was null.");
            return false;
