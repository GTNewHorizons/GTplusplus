...
public class GregtechRecipeAdder implements IGregtech_RecipeAdder {
	...
	public boolean addBlastSmelterRecipe(final ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput,
		...
		return (addBlastSmelterRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, 3700) &&
				addQuantumSmelterRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, 3700));
	}
	...
	public boolean addBlastSmelterRecipe(final ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, ItemStack[] aOutputStack,
		...
		return (addBlastSmelterRecipe(aInput, aInputFluid, aOutput, aOutputStack, aChance, aDuration, aEUt, 3700) &&
				addQuantumSmelterRecipe(aInput, aInputFluid, aOutput, aOutputStack, aChance, aDuration, aEUt, 3700));
	}
	...
	public boolean addBlastSmelterRecipe(ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, int aChance,
		...
		return (addBlastSmelterRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, aSpecialValue) &&
				addQuantumSmelterRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, aSpecialValue));
	}
	...
	@Override
	public boolean addQuantumSmelterRecipe(final ItemStack[] aInput, FluidStack aOutput, final int aChance, int aDuration,
										 final int aEUt) {
		return addQuantumSmelterRecipe(aInput, null, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, 3700);
	}

	@Override
	public boolean addQuantumSmelterRecipe(final ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput,
										 final int aChance, int aDuration, final int aEUt) {
		return addQuantumSmelterRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, 3700);
	}

	@Override
	public boolean addQuantumSmelterRecipe(final ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, ItemStack[] aOutputStack,
										 final int aChance[], int aDuration, final int aEUt) {
		return addQuantumSmelterRecipe(aInput, aInputFluid, aOutput, aOutputStack, aChance, aDuration, aEUt, 3700);
	}

	@Override
	public boolean addQuantumSmelterRecipe(ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, int aChance,
										 int aDuration, int aEUt, int aSpecialValue) {
		return addQuantumSmelterRecipe(aInput, aInputFluid, aOutput, new ItemStack[] {}, new int[] {aChance}, aDuration, aEUt, aSpecialValue);
	}

	@Override
	public boolean addQuantumSmelterRecipe(ItemStack[] aInput, FluidStack aInputFluid, FluidStack aOutput, ItemStack[] aOutputStack, int[] aChance,
										 int aDuration, int aEUt, int aSpecialValue) {
		if ((aInput == null) || (aOutput == null)) {
			Logger.WARNING("Fail - Input or Output was null.");
			return false;
		...
		if ((aDuration = GregTech_API.sRecipeFile.get("quantumsmelter", aOutput.getFluid().getName(), aDuration)) <= 0) {
			Logger.WARNING("Recipe did not register.");
			return false;
		}
		...
		int aSize = GTPP_Recipe.GTPP_Recipe_Map.sQuantumForceSmelterRecipes.mRecipeList.size();
		int aSize2 = aSize;
		GTPP_Recipe.GTPP_Recipe_Map.sQuantumForceSmelterRecipes.addRecipe(
				true,
				aInput,
				aOutputStack,
				null,
				...
				Math.max(1, aEUt),
				aSpecialValue);
		aSize = GTPP_Recipe.GTPP_Recipe_Map.sQuantumForceSmelterRecipes.mRecipeList.size();
