...
import gtPlusPlus.xmod.gregtech.common.tileentities.machines.multi.processing.advanced.fusion.*;
...
public class GregtechFactoryGradeReplacementMultis {
	...
	private static void run1() {
		...
		GregtechItemList.FusionComputer_UV2.set(new GregtechMetaTileEntity_Adv_Fusion_MK4(31076, "fusioncomputer.tier.09", "FusionTech MK IV").getStackForm(1L));
		GregtechItemList.FusionComputer_UV3.set(new GregtechMetaTileEntity_Adv_Fusion_MK5(965, "fusioncomputer.tier.10", "FusionTech MK V").getStackForm(1L));
