        ...
        if (!GTNH) {
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_LV_ULV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        ItemList.Hull_ULV,
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.Tin),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.Lead)
                    });
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_MV_LV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        ItemList.Hull_LV,
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.Copper),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.Tin)
                    });
            GT_ModHandler.addCraftingRecipe(
            ...
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_EV_HV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        ItemList.Hull_HV,
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.Aluminium),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.Gold),
                        Character.valueOf('K'),
            ...
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_IV_EV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        ItemList.Hull_EV,
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.Tungsten),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.Aluminium),
                        Character.valueOf('K'),
            ...
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_LuV_IV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        ItemList.Hull_IV,
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.VanadiumGallium),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.Tungsten),
                        Character.valueOf('K'),
            ...
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_ZPM_LuV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        ItemList.Hull_LuV,
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.Naquadah),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.VanadiumGallium),
                        Character.valueOf('K'),
                        mItem_1
            ...
            GT_ModHandler.addCraftingRecipe(
                    GregtechItemList.Transformer_HA_MV_LV.get(1L, new Object[0]), bitsd, new Object[] {
                        ...
                        Character.valueOf('C'),
                        OrePrefixes.wireGt4.get(Materials.AnyCopper),
                        Character.valueOf('B'),
                        OrePrefixes.wireGt4.get(Materials.Tin)
                    });
            GT_ModHandler.addCraftingRecipe(
