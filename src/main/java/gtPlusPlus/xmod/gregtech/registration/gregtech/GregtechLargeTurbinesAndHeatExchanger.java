...
public class GregtechLargeTurbinesAndHeatExchanger {
	...
	private static void run1() {		
		...
		GregtechItemList.AcceleratorEV.set(new GregtechMetaTileEntity_Adv_HeatExchanger(31079, "multimachine.reallybigheatexchanger", "Whakawhiti Wera XL").getStackForm(1L));
	}
}